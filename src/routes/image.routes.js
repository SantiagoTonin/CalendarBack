...
import { checkMaxImages } from "../middleware/errorMaxImage.middleware.js";
...
route.post("/image",checkAuth,checkMaxImages,upload.array("image"),deleteImage,createImages)
